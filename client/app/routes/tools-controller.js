...
angular.module("tools").config(["$routeProvider", function ($routeProvider) {
    $routeProvider
        .when("/external", {templateUrl: "app/routes/tools-view.html", controller: "ToolsController"});
}]);
...
angular.module("tool-new").config(["$routeProvider", function ($routeProvider) {
    $routeProvider
        .when("/tool/new", {templateUrl: "app/routes/tool-create-view.html", controller: "ToolNewController"});
}]);
